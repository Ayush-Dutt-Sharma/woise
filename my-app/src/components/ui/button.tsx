...
export function TailwindcssButtons(variant:string,click:string) {
    ...
    <div className="pb-40 px-4 w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-full  max-w-7xl mx-auto gap-10">
        {buttons.map((button, idx) => (
         variant===button.name && <ButtonsCard key={idx} onClick={() => click}>
            {button.component}
          </ButtonsCard>
        ))}
      </div>
...
export const buttons = [
...

  {
    ...
    component: (
      <button className="px-8 py-0.5  border-2 border-white uppercase bg-white text-neutarl-700 transition duration-200 text-sm shadow-[1px_1px_rgba(255,255,255),2px_2px_rgba(255,255,255),3px_3px_rgba(255,255,255),4px_4px_rgba(255,255,255),5px_5px_0px_0px_rgba(255,255,255)] ">
        Brutal
      </button>
    ),
  },
